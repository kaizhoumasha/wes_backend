...
- [WMS 业务 ACL 收敛计划](docs/superpowers/plans/2026-08-05-wes-wms-thin-access-convergence.md)：Phase 3 无状态、消费者驱动的暗构建入口；Task 1 四项跨能力外部门禁未关闭，关闭后按 operation 单独批准与实施。
