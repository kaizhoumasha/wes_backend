...
- [WMS HTTP Client 薄封装计划](docs/superpowers/plans/2026-08-05-wes-wms-thin-access-convergence.md)：Phase 3 已交付类似 Axios 的共享 WMS HTTP/JSON Client；具体 WMS 业务 API 随后续业务逐项实现。
