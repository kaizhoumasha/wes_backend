...
- [WES 架构收敛九阶段总控](docs/superpowers/plans/2026-08-03-wes-architecture-convergence-master-plan.md)：九阶段直接替换总控。
- [WMS 薄接入收敛计划](docs/superpowers/plans/2026-08-03-wes-wms-thin-access-convergence.md)：WMS 薄接入详细实施入口。
