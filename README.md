...
- [WES 架构收敛十二阶段总控](docs/superpowers/plans/2026-08-03-wes-architecture-convergence-master-plan.md)：Phase 6 已完成 Transport 正式基础基线，下一阶段由 Phase 7 收敛 Device/ECS；Phase 8/9 重写独立插件。
