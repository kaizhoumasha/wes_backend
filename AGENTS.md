...
This project is indexed by GitNexus as **wes_backend** (34680 symbols, 63391 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
