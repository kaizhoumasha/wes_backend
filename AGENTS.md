...
This project is indexed by GitNexus as **wes_backend** (22797 symbols, 38017 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
