...
from src.app.wms_integration.ports.query_inventory_operation import InventoryQueryOperationPort  # noqa: E402
...
SYSTEM_CAPABILITY_PORT_CATALOG: tuple[type[object], ...] = (InventoryQueryOperationPort,)
