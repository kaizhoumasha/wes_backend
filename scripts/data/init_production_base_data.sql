...
('biz:workline:start', 'biz:workline:group', '启动作业线', 'user_api', 'biz', 'workline', 'start', 'POST', '/api/v1/workline/operations/worklines/{workline_id}/start', 4, 3),
('biz:workline:deactivate', 'biz:workline:group', '停用作业线', 'user_api', 'biz', 'workline', 'deactivate', 'POST', '/api/v1/workline/work_lines/{id}/deactivate', 5, 3),
('biz:workline:restore', 'biz:workline:group', '批量恢复WorkLine', 'user_api', 'biz', 'workline', 'restore', 'POST', '/api/v1/workline/work_lines/trash/restore', 6, 3),
('biz:workline:permanent_delete', 'biz:workline:group', '批量永久删除WorkLine', 'user_api', 'biz', 'workline', 'permanent_delete', 'DELETE', '/api/v1/workline/work_lines/trash/permanent', 7, 3),
('biz:workline:trash', 'biz:workline:group', '获取已删除WorkLine', 'user_api', 'biz', 'workline', 'trash', 'GET', '/api/v1/workline/work_lines/trash', 8, 3),
('biz:workline:create', 'biz:workline:group', '创建WorkLine', 'user_api', 'biz', 'workline', 'create', 'POST', '/api/v1/workline/work_lines', 9, 3),
('biz:workline:update', 'biz:workline:group', '更新WorkLine', 'user_api', 'biz', 'workline', 'update', 'PUT', '/api/v1/workline/work_lines/{id}', 10, 3),
('biz:workline:delete', 'biz:workline:group', '删除WorkLine', 'user_api', 'biz', 'workline', 'delete', 'DELETE', '/api/v1/workline/work_lines/{id}', 11, 3),
('biz:workline:view-runtime-hold', 'biz:workline:group', '查询 Runtime Hold NG 原因选项', 'user_api', 'biz', 'workline', 'view-runtime-hold', 'GET', '/api/v1/workline/runtime-holds/ng-reasons', 12, 3),
('biz:workline:resolve-runtime-hold', 'biz:workline:group', '解除 Runtime Hold', 'user_api', 'biz', 'workline', 'resolve-runtime-hold', 'POST', '/api/v1/workline/runtime-holds/{hold_id}/resolve', 13, 3),
('biz:workline:list-ng-return-item', 'biz:workline:group', '查询 NG Return Items', 'user_api', 'biz', 'workline', 'list-ng-return-item', 'GET', '/api/v1/workline/ng-return-items', 14, 3),
('biz:workline:resolve-reconciliation', 'biz:workline:group', '解除 runtime reconciliation 隔离，不重发设备命令、不调用 timeout 插件处理、释放安全停靠队列', 'user_api', 'biz', 'workline', 'resolve-reconciliation', 'POST', '/api/v1/workline/operations/reconciliations/sessions/{session_id}/resolve', 15, 3),
('biz:workline:clear-estop', 'biz:workline:group', '人工确认 checklist 后清除工作线急停', 'user_api', 'biz', 'workline', 'clear-estop', 'POST', '/api/v1/workline/operations/safety/worklines/{workline_id}/clear-estop', 16, 3),
('biz:workline:cleanup-sandbox', 'biz:workline:group', '清理工作线沙箱运行时数据', 'user_api', 'biz', 'workline', 'cleanup-sandbox', 'POST', '/api/v1/workline/operations/sandbox/worklines/{workline_id}/cleanup', 17, 3),
('biz:workline:cleanup-debug-data', 'biz:workline:group', '清理工作线调试过程数据', 'user_api', 'biz', 'workline', 'cleanup-debug-data', 'POST', '/api/v1/workline/operations/debug-data/worklines/{workline_id}/cleanup', 18, 3),
