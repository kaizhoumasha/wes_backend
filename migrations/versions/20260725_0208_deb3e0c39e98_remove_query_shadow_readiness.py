"""remove query shadow readiness

Revision ID: deb3e0c39e98
Revises: 65e212c90737
Create Date: 2026-07-25 02:08:51.653770+08:00
...
revision: str = "deb3e0c39e98"
down_revision: Union[str, Sequence[str], None] = "65e212c90737"
...
def downgrade() -> None:
    """重建空的 shadow/readiness 结构；系统尚未上线，不恢复测试数据。"""
    op.execute(
        sa.text(
            """
