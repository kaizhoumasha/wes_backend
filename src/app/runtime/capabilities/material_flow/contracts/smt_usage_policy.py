...
PREFERRED_FULL_BOX_EXCHANGE_REQUESTED_DECISION = "PREFERRED_FULL_BOX_EXCHANGE_REQUESTED"
REQUIRED_FULL_BOX_EXCHANGE_REQUESTED_DECISION = "REQUIRED_FULL_BOX_EXCHANGE_REQUESTED"
...
__all__ = [
    "PREFERRED_FULL_BOX_EXCHANGE_REQUESTED_DECISION",
    "REQUIRED_FULL_BOX_EXCHANGE_REQUESTED_DECISION",
    "SMT_USAGE_POLICY",
    "SmtUsageBand",
    "SmtUsagePolicy",
    "SmtUsageResult",
