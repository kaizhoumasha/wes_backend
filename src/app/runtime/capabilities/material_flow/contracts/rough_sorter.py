...
# approved 13-case 决策的稳定 Hold/evidence 原因码；Plugin 与 legacy characterization 共用。
REASON_ROUGH_SORTER_CONTEXT_MISSING = "ROUGH_SORTER_CONTEXT_MISSING"
REASON_ROUGH_SORTER_MEASUREMENT_INVALID = "ROUGH_SORTER_MEASUREMENT_INVALID"
REASON_ROUGH_SORTER_PICK_RESULT_TIMEOUT = "ROUGH_SORTER_PICK_RESULT_TIMEOUT"
REASON_WMS_TIMEOUT = "WMS_TIMEOUT"
REASON_IDEMPOTENCY_CONFLICT = "IDEMPOTENCY_CONFLICT"
REASON_COMMAND_RESULT_CORRELATION_MISMATCH = "COMMAND_RESULT_CORRELATION_MISMATCH"
