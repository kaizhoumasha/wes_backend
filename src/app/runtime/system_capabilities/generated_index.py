...
SYSTEM_CAPABILITY_INDEX_DIGEST = "917dd149e162252e7397b47e848514ae90f329f362a1581e4f86e14f2ed57052"
SYSTEM_CAPABILITY_INDEX = MappingProxyType(
    {
        ...
        ("wms.fulfillment.request_load_unit_transport", "v1"): _DEFINITION_13,
        ("wms.fulfillment.request_rack_supply", "v1"): _DEFINITION_14,
        ("wms.fulfillment.request_rack_transport", "v1"): _DEFINITION_15,
        ("wms.inventory.confirm_inbound", "v1"): _DEFINITION_16,
        ("wms.inventory.confirm_outbound", "v1"): _DEFINITION_17,
        ("wms.inventory.confirm_return_putaway", "v1"): _DEFINITION_18,
        ("wms.inventory.get_reservation", "v1"): _DEFINITION_19,
        ("wms.inventory.query_inventory", "v1"): _DEFINITION_20,
        ("wms.inventory.release_reservation", "v1"): _DEFINITION_21,
        ("wms.inventory.reserve_inventory", "v1"): _DEFINITION_22,
        ("wms.inventory.transfer_inventory", "v1"): _DEFINITION_23,
        ("wms.master_data.get_bin", "v1"): _DEFINITION_24,
        ("wms.master_data.get_material", "v1"): _DEFINITION_25,
        ("wms.master_data.get_rack", "v1"): _DEFINITION_26,
        ("wms.master_data.list_locations", "v1"): _DEFINITION_27,
        ("wms.master_data.list_materials", "v1"): _DEFINITION_28,
        ("wms.master_data.list_racks", "v1"): _DEFINITION_29,
        ("wms.master_data.list_zones", "v1"): _DEFINITION_30,
        ("wms.reconciliation.check_bin_drift", "v1"): _DEFINITION_31,
        ("wms.reconciliation.check_full_drift", "v1"): _DEFINITION_32,
        ("wms.reconciliation.check_rack_drift", "v1"): _DEFINITION_33,
    }
)
