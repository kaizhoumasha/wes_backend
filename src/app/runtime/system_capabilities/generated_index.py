...
SYSTEM_CAPABILITY_INDEX_DIGEST = "aea57e1f2a012db8a55e4a3157a264ef74b0863cacb4c3a001caceb9d30a5b93"
SYSTEM_CAPABILITY_INDEX = MappingProxyType(
    {
        ("material_flow.material_unit_write", "v1"): _DEFINITION_0,
        ("runtime.session_hold", "v1"): _DEFINITION_1,
        ("wms.document.get_grn", "v1"): _DEFINITION_2,
        ("wms.document.get_outbound_order", "v1"): _DEFINITION_3,
        ("wms.document.get_pick_order", "v1"): _DEFINITION_4,
        ("wms.document.get_task_snapshot", "v1"): _DEFINITION_5,
        ("wms.document.get_wave", "v1"): _DEFINITION_6,
        ("wms.document.list_grn_packages", "v1"): _DEFINITION_7,
        ("wms.fulfillment.cancel_request", "v1"): _DEFINITION_8,
        ("wms.fulfillment.change_rack_face", "v1"): _DEFINITION_9,
        ("wms.fulfillment.notify_pkg_binding", "v1"): _DEFINITION_10,
        ("wms.fulfillment.publish_manual_task", "v1"): _DEFINITION_11,
        ("wms.fulfillment.request_rack_supply", "v1"): _DEFINITION_12,
        ("wms.inventory.confirm_inbound", "v1"): _DEFINITION_13,
        ("wms.inventory.confirm_outbound", "v1"): _DEFINITION_14,
        ("wms.inventory.confirm_return_putaway", "v1"): _DEFINITION_15,
        ("wms.inventory.get_reservation", "v1"): _DEFINITION_16,
        ("wms.inventory.query_inventory", "v1"): _DEFINITION_17,
        ("wms.inventory.release_reservation", "v1"): _DEFINITION_18,
        ("wms.inventory.reserve_inventory", "v1"): _DEFINITION_19,
        ("wms.inventory.transfer_inventory", "v1"): _DEFINITION_20,
        ("wms.master_data.get_bin", "v1"): _DEFINITION_21,
        ("wms.master_data.get_material", "v1"): _DEFINITION_22,
        ("wms.master_data.get_rack", "v1"): _DEFINITION_23,
        ("wms.master_data.list_locations", "v1"): _DEFINITION_24,
        ("wms.master_data.list_materials", "v1"): _DEFINITION_25,
        ("wms.master_data.list_racks", "v1"): _DEFINITION_26,
        ("wms.master_data.list_zones", "v1"): _DEFINITION_27,
        ("wms.reconciliation.check_bin_drift", "v1"): _DEFINITION_28,
        ("wms.reconciliation.check_full_drift", "v1"): _DEFINITION_29,
        ("wms.reconciliation.check_rack_drift", "v1"): _DEFINITION_30,
    }
)
