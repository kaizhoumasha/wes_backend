"""满箱交换 typed callback 到 T8d reducer 的唯一适配。"""
...
class FullBoxExchangeCallbackAdapter:
...
full_box_exchange_callback_adapter = FullBoxExchangeCallbackAdapter()

__all__ = ["FullBoxExchangeCallbackAdapter", "full_box_exchange_callback_adapter"]
