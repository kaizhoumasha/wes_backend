        ...
        *,
        ...
        for event in resolved.events:
            ...
            if is_e12_transport_failure:
                ...
                if should_reconcile:
                    reason_code = event.reason_code or "WMS_E12_TRANSPORT_FAILURE_AFTER_LOCAL_FACT"
                    evidence_json = {
                        **event.evidence_json,
                    ...
                    continue
                if event.event_type is EffectReducerEventType.TRANSPORT_NOT_SENT:
