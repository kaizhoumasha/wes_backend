"""`outbound.bin.return_batch@v1` 可靠派发适配器。"""
...
class BinReturnBatchAdapter:
    """校验冻结请求，通过共享 WmsClient 单次发送并解释 return_batch 响应。"""
    ...
    async def dispatch(
        ...
        *,
        ...
        try:
            request = parse_bin_return_batch_request(request_payload, observation=observation)
        ...
        try:
            response = parse_bin_return_batch_response(
