"""ScenarioReplayRunner resilience fixture replay."""
...
FIXTURE_PATH = Path(__file__).with_name("fixtures") / "runtime_replay_fixture.json"
SIMULATOR_FIXTURE_PATH = Path(__file__).with_name("fixtures") / "runtime_simulator_replay_fixture.json"
...
def test_runtime_resilience_fixture_replays_deterministically() -> None:
...
def test_runtime_simulator_fixture_records_and_replays_deterministically() -> None:
...
def test_runtime_trace_query_result_records_production_replay_source() -> None:
    ...
    recording = ScenarioRecorder().record_trace_query_result(
        scenario_id="runtime-production-trace",
