"""Phase 3 IntegrationLab fixture runner contract."""
...
FIXTURE_PATH = Path(__file__).with_name("fixtures") / "phase3_integration_lab_fixture.json"
...
def test_phase3_integration_lab_fixture_runs_full_wms_ecs_chain() -> None:
...
def test_phase3_integration_lab_rejects_non_sandbox_provider_profile() -> None:
