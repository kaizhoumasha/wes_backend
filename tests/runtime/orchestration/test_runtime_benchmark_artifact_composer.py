"""Runtime production benchmark artifact composer contract."""
...
def test_runtime_benchmark_composer_builds_gate_valid_production_artifact(tmp_path) -> None:
...
def test_runtime_benchmark_composer_rejects_missing_required_scenario_evidence(tmp_path) -> None:
...
def test_runtime_benchmark_composer_rejects_non_production_environment(tmp_path, environment: str) -> None:
    from src.app.runtime.orchestration.benchmark_artifact_composer import (
        RuntimeBenchmarkArtifactComposer,
        RuntimeBenchmarkArtifactCompositionError,
    )
