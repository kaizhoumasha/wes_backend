...
ROOT_LEVEL_TEST_FILE_ALLOWLIST = {
    ...
    "tests/test_device_command_service_contract.py",
    "tests/test_device_context_service.py",
    "tests/test_device_service_runtime_state.py",
    "tests/test_docker_compose_mock_urls.py",
    "tests/test_error_handlers_dbapi.py",
    "tests/test_event_stream_service.py",
    "tests/test_exceptions.py",
    "tests/test_frontend_menu_parser.py",
    "tests/test_health_endpoint.py",
    "tests/test_log_center_models.py",
    "tests/test_menu_repository_superuser_filter.py",
    "tests/test_menu_service_tree.py",
    ...
    "tests/test_user_api_routes.py",
    "tests/test_user_model.py",
    "tests/test_user_service_assign_roles.py",
