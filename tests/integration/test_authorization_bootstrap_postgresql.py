        ...
        async with temporary_database() as (_database, database_url):
            ...
            try:
                async with session_factory() as db:
                    ...
                    assert fresh_preview.permissions.created == 169
                    ...
                    current_read_permissions = {
                        "ops:transport-callback-receipt:group",
                        "ops:transport-callback-receipt:read",
                        "ops:wms-confirmation:group",
                        "ops:wms-confirmation:read",
                        "ops:wms-evidence:group",
