...
from src.app.handling.services import (
...
def test_full_box_exchange_operation_types_require_callback_plus_reconciliation(operation_type: str) -> None:
    ...
    assert is_reconciled_exchange_operation_type(operation_type) is True
...
def test_rack_bin_exchange_operation_types_require_callback_plus_reconciliation(operation_type: str) -> None:
...
def test_non_full_box_operation_types_use_callback_trusted(operation_type: str) -> None:
    assert is_full_box_exchange_operation_type(operation_type) is False
    assert is_reconciled_exchange_operation_type(operation_type) is False
