...
This project is indexed by GitNexus as **wes_backend** (30408 symbols, 56405 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
