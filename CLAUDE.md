...
This project is indexed by GitNexus as **wes_backend** (31545 symbols, 54935 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
