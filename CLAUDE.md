...
This project is indexed by GitNexus as **wes_backend** (27540 symbols, 50709 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
