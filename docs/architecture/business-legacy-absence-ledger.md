...
| disposition | 数量 | 说明 |
| --- | ---: | --- |
| moved | 55 | 旧 WorkLine business contracts / services 已迁入 material-flow contracts 或 runtime capability service |
...
| already-removed | 21 | 前序 material-flow 迁移已移除的历史 WorkLine service rows，仅保留审计闭环 |
