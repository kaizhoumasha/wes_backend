...
- `uv run pytest tests/resilience/test_wms_circuit_breaker.py tests/wms_integration/test_wms_client.py tests/wms_integration/test_fulfillment_state_machine.py -q`：49 passed
...
- 护栏测试：stable architecture boundary guardrail tests
