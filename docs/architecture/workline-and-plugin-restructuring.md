...
- [ ] WMS breaker/evidence、DeviceCommand ACK age、RuntimeInbox/Outbox 等关键指标已纳入观测口径。🟡 PR #73 已落地 typed evidence envelope 与 observability contract；本分支补齐 WMS breaker/evidence instrumentation、retention/archive、exporter bridge 和 DeviceCommand ACK age instrumentation；RuntimeInbox/Outbox 生产指标接线仍待补齐。
