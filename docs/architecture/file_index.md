...
| `docs/superpowers/plans/2026-08-03-wes-legacy-production-path-removal.md` | Phase 10 旧 Runtime/Intent/Outbox/Hold/Provider 生产路径原子退役计划；当前受 Phase 9、successor closure 和 `UNRESOLVED=0` 门禁约束 |
