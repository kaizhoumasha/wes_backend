...
**最后更新**: 2026年6月30日（phase2-stage3-burndown-docs: Phase 2 burn-down 阶段 3 — wlr 整目录物理删除 178 文件 + diagnostics 子目录内部化 + consumers/ 退出 R-WLR trust zone + 9 tests + 2 scripts wlr import 重定向 + 版本 0.10.0.0 → 0.10.1.0 patch）
