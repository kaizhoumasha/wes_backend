...
| `docs/superpowers/plans/2026-08-05-wes-wms-thin-access-convergence.md` | Phase 3 无状态 WMS 业务 ACL 暗构建计划；inbound `NONE` 已冻结，Task 1 三项跨能力外部门禁未关闭，关闭后每个 operation 使用独立小 PR 实施 |
