...
| `docs/superpowers/plans/2026-08-19-rough-sorter-workline-epoch-activation.md` | WorkLine Epoch 激活、多 Endpoint 派发及其前端入口的增量实施真源；后端工程包 1–4 已提交，前端工程包 5 按独立门禁待实施 |
