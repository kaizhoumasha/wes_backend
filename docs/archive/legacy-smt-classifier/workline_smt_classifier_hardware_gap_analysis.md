...
- `workline_smt_classifier_runtime_flow.md` 的旧版本曾把某些 OK 流程描述成”扫码 OK 后不下命令、等待检测事件”
...
| P2-3 | 契约变更文档化机制 | plugin contract 变更时有固定升级说明和回写流程 | `workline_smt_classifier_runtime_flow.md`、本文件、相关设计文档 | 每次 contract 变更都能明确记录变更点、迁移方式、验收结果 |
