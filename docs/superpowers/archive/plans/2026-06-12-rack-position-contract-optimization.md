...
> **Acceptance Audit (2026-06-15):** 本计划作为 2026-06-12 manifest refactor 的语义修正已落地，并由 2026-06-14 rename 计划完成公开命名收口。下方 checkbox 按当前 `RackPosition` 实现、真实插件金样例、模板资产测试和 focused backend pytest 通过结果勾选；原计划中 `Position` 命名相关描述仅保留为历史决策记录。
...
- [x] **Step 1: 运行 GitNexus impact analysis**
...
- [x] **Step 2: 写失败测试：material flow 只能连接货架位**
...
- [x] **Step 3: 写失败测试：rough_sorter 不声明内部物理点位**
...
- [x] **Step 4: 写失败测试：rough_sorter 内部动作命令不强制 position_args**
...
- [x] **Step 2: 精简 rough_sorter topology**
...
- [x] **Step 3: 精简 rough_sorter command position_args**
...
- [x] **Step 3: 运行 GitNexus detect changes**
