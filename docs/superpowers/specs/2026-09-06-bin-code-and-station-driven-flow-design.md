...
> 2026-09-10 目标补充：[点位事件驱动、执行恢复与 WMS 对账顶层设计](2026-09-10-station-driven-execution-recovery-top-level-design.md)进一步明确新事件不等待旧对象业务对账。本文全程实体退役等有效范围保留；跨点处置关联与本站等待规则按新目标逐项评审后同步合同，不能直接删除必要信息校验或声称已经实现。
