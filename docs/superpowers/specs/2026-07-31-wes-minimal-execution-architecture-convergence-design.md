...
> 2026-09-10 目标补充：[点位事件驱动、执行恢复与 WMS 对账顶层设计](2026-09-10-station-driven-execution-recovery-top-level-design.md)明确本架构中点位独立触发、异常阻塞范围和最终业务对账归属的收敛目标。对应具体合同尚待同步评审；本文件其余有效范围保留，不能把旧恢复条款或历史验收当作新目标已实现的证据。
