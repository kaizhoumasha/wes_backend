...
| `plans/2026-08-03-wes-architecture-convergence-master-plan.md` | 十四阶段收敛总控 | In progress；Phase 1 至 7 已完成；Phase 8 后端 RC 已关闭；Phase 9 计划已批准、生产实施未开始；Phase 10–14 尚未开始 |
...
| `specs/2026-08-26-phase9-14-guided-development-resequence-design.md` | 开发流程、运输诊断、Phase 9 最小基础、Phase 10/11 收敛与 Phase 12 教学式插件开发重排 | Approved；Gate A 已完成；Gate B 已完成前后端仓内交付，未部署、未现场验收；Phase 9 计划已批准、生产实施未开始 |
| `plans/2026-08-27-phase9-minimum-execution-foundation.md` | Phase 9 最小执行内核、七项 successor、测试 owner 和 Phase 10 handoff | Approved；2026-08-28 实施前评审通过，生产实施未开始 |
