...
| `specs/2026-08-26-phase9-14-guided-development-resequence-design.md` | 开发流程、运输诊断、Phase 9 最小基础、Phase 10/11 收敛与 Phase 12 教学式插件开发重排 | Approved；backend/frontend planning baseline 已分别闭合，Gate A 已完成 |
| `plans/2026-08-27-phase9-minimum-execution-foundation.md` | Phase 9 最小执行内核、七项 successor、测试 owner 和 Phase 10 handoff | ReviewRequired；Gate A 已完成，Gate B 和本计划批准前不得开始生产实施 |
